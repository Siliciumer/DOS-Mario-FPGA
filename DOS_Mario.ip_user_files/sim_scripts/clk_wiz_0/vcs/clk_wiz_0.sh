...
#
# Generated by Vivado on Fri Jun 03 20:20:53 +0200 2016
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3_0" \
    "$ref_dir/../../../../DOS_Mario.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../DOS_Mario.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
